...
import { newCity, states } from "../../components/cities";
  ...
  return (
    <>
      <div className="flex justify-center flex-col items-center min-h-[100vh] w-full">
        <Navbar menu={"/crop-recommend"} />
        <section className=" body-font pt-24 pb-10 w-full relative">
          {!result && (
            <>
              <TitleCont title="Crop Predictor" />
                  ...
                  <div className="flex flex-wrap -m-2">
                    <div className="p-2 w-1/2">
                      <div className="relative">
                        ...
                        <input
                          ...
                          id="nitrogen"
                          name="nitrogen"
                          className="w-full bg-opacity-50 rounded border focus:border-dark-green focus:bg-secondary-light focus:ring-2 focus:ring-light-green text-base outline-none py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                        />
                      </div>
                    </div>
                    <div className="p-2 w-1/2">
                    ...
                    <div className="p-2 w-1/2">
                      <div className="relative">
                        <div
                          className="absolute bottom-2 text-dark-green text-3xl cursor-pointer -right-9"
                          onClick={() =>
                            setFocus({ ...focus, fourth: !focus.fourth })
                          }
                        >
                          {/* {focus.fourth === true ? (
                            <MdRecordVoiceOver />
                        ...
                        <label htmlFor="ph" className="leading-7 text-sm ">
                          Enter PH Level
                        </label>
                        <input
                          value={data.ph}
                    ...
                    {/* <div className="p-2 w-1/2">
                      <div className="relative">
                        <div
                          className="absolute bottom-2 text-dark-green text-3xl cursor-pointer -left-9"
                          onClick={() =>
                            setFocus({ ...focus, fifth: !focus.fifth })
                          }
                        >
                          {focus.fifth === true ? (
                            <MdRecordVoiceOver />
                        ...
                        <input
                          value={data.rainfall}
                          onChange={(e) =>
                            setData({ ...data, rainfall: e.target.value })
                          }
                          type="text"
                          placeholder="40"
                          id="rainfall"
                    ...
                    <div className="p-2 w-1/2">
                      <div className="relative">
                        ...
                        <select
                          ...
                          className="w-full bg-opacity-50 rounded border focus:border-dark-green focus:bg-secondary-light focus:ring-2 focus:ring-light-green text-base outline-none py-1 px-3 leading-8 transition-colors duration-200 ease-in-out appearance-none"
                        >
                    ...
                    <div className="p-2 w-1/2">
                      <div className="relative">
                        ...
                        >
                          <option defaultValue>-- Select --</option>
                          {newCity[states.indexOf(data.state) + 1].map(
                            (item) => {
                              return <option value={item}>{item}</option>;
                            }
                          )}
                    ...
                    <div className="p-2 w-full mt-8 mx-auto">
                      <button
                        className="flex mx-auto text-primary-light bg-dark-green border-2 border-dark-green py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-base transition-all ease-linear duration-300 hover:transition-all hover:duration-300 hover:ease-linear hover:bg-primary-light hover:text-dark-green"
                        onClick={onSubmit}
                      >
                        Submit Data
                      </button>
          ...
          {result && (
            <>
              ...
              <div className="w-full flex justify-center items-center mx-auto bg-secondary-light">
                <div
                  className="w-[50%] relative flex flex-col justify-center items-center border-[1.4px] rounded-md border-[#181818] px-10 pt-6"
                  id="print"
                >
                  <svg
                  ...
                  <p className="font-semibold text-2xl text-center z-20">
                    Results of Crop Predictor
                  </p>
                  <div className="mt-4 z-20 w-full">
                    <p className="text-xl font-medium my-4 border-b-2 border-light-green">
                      User Input
                    </p>
                    <div className="flex justify-evenly items-center flex-wrap mx-auto">
                      ...
                      <p className="text-base font-normal w-1/2 mt-1">
                    ...
                    <p className="text-xl font-medium my-4 border-b-2 border-light-green mt-4">
                      User Weather Details
                    </p>
                    <div className="flex justify-evenly items-center flex-wrap mx-auto">
                      <p className="text-base font-normal w-1/2 mt-1">
                      ...
                      {/* <p className="text-base font-normal w-full mt-1">
                  ...
                  <div className="z-20 w-full">
                    <p className="text-xl font-medium my-4 border-b-2 border-light-green">
                      Recommended Crop To Be Grown
                    </p>
                    <p className="text-xl mt-2 font-medium flex items-center">
                      <svg
                        className="mr-2"
                        fill="#29AB87"
                        width="26px"
