...
const CropDisease = () => {
  ...
  useEffect(() => {
    document.title = "Crop Disease Predictor";
  }, []);
    ...
    const Upload = async () => {
      ...
      await fetch("/disease-predict", {
        ...
        resp
          .json()
          .then((data) => {
            console.log(data.file.split("<br/>").length);
            toast.dismiss();
            setResult(data);
            let date = new Date();
            setReportDate(
  ...
  return (
    <>
      <div
        className="flex justify-center flex-col items-center min-h-[100vh] w-full py-10"
        id="printContainer1"
      >
        <Navbar menu={"/crop-disease"} />
        <section
          className="body-font relative pt-14 w-full"
          id="printContainer2"
        >
          {!result && (
            <>
              <TitleCont title="Crop Disease Predictor" />
              <form
                ...
                {file && (
                  <div className="mx-auto relative">
                    <img
                      src={file}
                      alt="user added"
                      className="rounded-xl shadow-lg h-[200px] object-contain"
                    />
                    <div
              ...
              >
                <div className="relative flex flex-col justify-center items-center">
                  ...
                  <p className="font-semibold text-2xl pb-2 text-center z-20 border-b-2 border-light-green w-full">
                    Results of Crop Disease Predictor
                  </p>
                  ...
                  <div className="mt-4 z-20 w-full">
                    <div className="border-b-2 border-light-green py-2">
                      ...
                      <p className="my-1 text-base font-medium">
                        {result && result.file.split("<br/>")[1]}
                      </p>
                    </div>
                    {result &&
                      result.file.split("<br/>")[1] !==
                        "Disease: No disease" && (
                        <>
                          <div className="border-b-2 border-light-green py-2">
                            ...
                            <p className="my-1 text-base font-normal">
                              {result && result.file.split("<br/>")[5]}
                            </p>
                          </div>
                          <div className="py-2">
                            <p className="text-lg mt-2 font-medium flex items-center">
                            ...
                            {result.file.split("<br/>").map((item, index) => {
                              if (index >= 9 && !item.includes("cure")) {
                                return (
                                  <p
                                    key={index}
